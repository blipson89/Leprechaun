...
namespace Leprechaun.InputProviders.Sitecore.MetadataGeneration
{
	public class SitecoreTemplateMetadataGenerator : StandardTemplateMetadataGenerator
	{
		public override IReadOnlyList<ConfigurationCodeGenerationMetadata> Generate(params TemplateConfiguration[] configurations)
		{
